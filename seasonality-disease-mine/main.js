(function($) {
  ...
  function resize() {
    ...
    svg.selectAll('.yr-txt')
      .attr('transform', function(d) {
        return (width < 500) ? "translate(" + 2 + "," + (y(d.year) * 1) + ")" : "translate(" + (x('Timeline') - 80) + "," + (y(d.year) * 1) + ")";
      })
  ...
  function drawViz(data) {
    ...
    var yrtxt = svg.selectAll('.yr-txt')
      ...
      .attr('transform', function(d) {
        ...
        console.log(y(1));
        return (width < 500) ? "translate(" + 2 + "," + y(d.year) + ")" : "translate(" + (x('Timeline') - 80) + "," + (y(d.year)) + ")";
      })
      .append('text')
      .text(function(d) {
        return d.names
    ...
    var coltxt = svg.selectAll('.col-txt')
      ...
      .attr('transform', function(d) {
        if (width < 500) {
          return "translate(" + x(d.disease) + "," + (y(1) - y(1) /3) + ")";


        } else {
          return "translate(" + x(d.disease) + "," + (y(1) - y(1) / 2) + ")";
