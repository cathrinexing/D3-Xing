  ...
  function resize() {
    ...
    svg.selectAll('.col-txt')
      .attr('transform', function(d) {
        console.log(x(d.disease));
        return "translate(" + x(d.disease) + "," + (y(d.year) - 15) + ")";
    ...
    svg.selectAll('.col-txt2')
      .attr('transform', function(d) {
        if (width < 500) {
          return "translate(" + (x(d.disease) * 0.5) + "," + (y(d.year) - 45) + ")";
        } else {
          return "translate(" + (x(d.disease) * 0.5) + "," + (y(d.year) - 65) + ")";
        }
      });
    ...
    svg.selectAll('.yr-txt3')
      .attr('transform', function(d) {
        return (width < 500) ? "translate(" + 2 + "," + (y(d.year) + 20) + ")" : "translate(" + (x('Timeline') - 30) + "," + (y(d.year) + 20) + ")";
      })
  ...
  function drawViz(data) {
    ...
    var yrtxt = svg.selectAll('.yr-txt')
      ...
      .attr('transform', function(d) {
        ...
        return (width < 500) ? "translate(" + 2 + "," + y(d.year) + ")" : "translate(" + (x('Timeline') - 80) + "," + (y(d.year) - 10) + ")";
      })
      .append('text')
      .text(function(d) {
        return d.names
    ...
    var yrtxt3 = svg.selectAll('.yr-txt3')
      ...
      .attr('class', 'yr-txt3')
      .attr('transform', function(d) {
        return (width < 500) ? "translate(" + 2 + "," + (y(d.year) + 20) + ")" : "translate(" + (x('Timeline') - 80) + "," + (y(d.year) + 20) + ")";
      })
      .append('text')
      .text(function(d) {
        return d.date
